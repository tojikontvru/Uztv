...
# ============================================
print_header "📦 ШАГ 1/9: ПОДГОТОВКА СИСТЕМЫ"
...
# 2. УСТАНОВКА GRADLE
# ============================================
print_header "📦 ШАГ 2/9: УСТАНОВКА GRADLE"
...
# ============================================
print_header "📦 ШАГ 3/9: УСТАНОВКА NODE.JS 20"
...
# ============================================
print_header "🤖 ШАГ 4/9: УСТАНОВКА ANDROID SDK"
...
# ============================================
print_header "📱 ШАГ 5/9: СОЗДАНИЕ ПРИЛОЖЕНИЯ"
cd /root
rm -rf SafaraliApp
...
# 6. СБОРКА APK
# ============================================
print_header "🔨 ШАГ 6/9: СБОРКА APK"
cordova build android --release -- --packageType=apk

# ============================================
# 7. СОЗДАНИЕ ВЕБ-ПАНЕЛИ
# ============================================
print_header "🌐 ШАГ 7/9: СОЗДАНИЕ ВЕБ-ПАНЕЛИ"
...
# ============================================
# 8. НАСТРОЙКА PHP И NGINX
# ============================================
print_header "🔧 ШАГ 8/9: НАСТРОЙКА PHP И NGINX"
...
# ============================================
# 9. АВТОМАТИЧЕСКАЯ ПЕРЕСБОРКА
# ============================================
print_header "🤖 ШАГ 9/9: АВТОМАТИЧЕСКАЯ ПЕРЕСБОРКА"
