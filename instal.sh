...
# ============================================
# SAFARALI GROUP - FULL BUILD SERVER
...
apt install -y curl wget git unzip zip nginx nodejs npm openjdk-17-jdk

# ============================================
# 2. УСТАНОВКА CORDOVA
# ============================================
print_header "📱 ШАГ 2/8: УСТАНОВКА CORDOVA"
...
# ============================================
# 6. СОЗДАНИЕ ВЕБ-ПАНЕЛИ УПРАВЛЕНИЯ
# ============================================
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-building { background: rgba(245,158,11,0.2); color: #f59e0b; }
        .info-box {
            background: rgba(0,0,0,0.3);
            border-radius: 16px;
            padding: 1rem;
    ...
    <div class="container">
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="info-box">
                    ...
                    <p><strong>Android SDK:</strong> API 35</p>
                </div>
        ...
        <div class="card" style="margin-top: 2rem;">
            ...
            <ol style="margin-left: 1.5rem; color: rgba(255,255,255,0.8);">
                ...
                <li>Откройте приложение и нажмите "Создать аккаунт"</li>
                <li>В поле "Домашний сервер" укажите: <code>https://safaraligroup.uz</code></li>
                <li>Зарегистрируйтесь и начните общение!</li>
            </ol>
        </div>
    </div>
    
    <script>
        const API_TOKEN = prompt('🔑 Введите API токен (находится в /root/api_token.txt)');
...
# 7. НАСТРОЙКА NGINX
# ============================================
print_header "🔧 ШАГ 7/8: НАСТРОЙКА NGINX"
...
# ============================================
print_header "🤖 ШАГ 8/8: НАСТРОЙКА АВТОСБОРКИ"
...
- Автоматическая пересборка в 3:00
